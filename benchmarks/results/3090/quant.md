...
| ÷∏±Í | ÷µ | µ•Œª | ±∏◊¢ |
|---|---|---|---|
| fp matmul | 0.0643 | ms | weight 16384 KiB |
| int8 matmul | 0.1004 | ms | weight 4096 KiB, rel err 0.83% |
| int8 compression | 4.0 | x | vs fp32 weight |
| nf4 matmul | 0.2292 | ms | weight 4352 KiB, rel err 9.20% |
| nf4 compression | 3.7647 | x | vs fp32 weight |
| nf4 quantize | 2.2608 | ms | one-time, per weight tensor |
